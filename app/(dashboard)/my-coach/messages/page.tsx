...
export default function MyCoachMessagesPage() {
    ...
    return (
      <div className="max-w-2xl">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-10 text-center">
          <p className="text-gray-600 font-medium">No coaching relationship</p>
          <p className="text-sm text-gray-400 mt-1">Connect with a coach to start messaging.</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="max-w-2xl">
      <div className="flex items-center gap-3 mb-6">
        <a href="/my-coach" className="text-sm text-gray-500 hover:text-gray-700 flex items-center gap-1">
      ...
      <div className="bg-white rounded-xl border border-gray-200 flex flex-col h-[calc(100vh-320px)] min-h-[400px]">
        {/* Message list */}
        <div className="flex-1 overflow-y-auto p-5 space-y-3">
          {messages.length === 0 ? (
            <div className="flex items-center justify-center h-full">
              <p className="text-sm text-gray-400">No messages yet. Say hello to your coach.</p>
            </div>
          ) : (
            messages.map((msg) => {
              ...
              return (
                <div key={msg.id} className={`flex ${isClient ? 'justify-end' : 'justify-start'}`}>
                  ...
                  >
                    ...
                    <p className={`text-xs mt-1 ${isClient ? 'text-primary-200' : 'text-gray-400'}`}>
