...
export default async function SubscribePage() {
  ...
  // ACTIVE users with a billing account have nothing to set up here
  ...
  return (
    <div className="max-w-2xl mx-auto py-8">
      <div className="mb-8">
        {trialActive ? (
          <>
            <h1 className="text-2xl font-bold text-gray-900">Set up your subscription</h1>
            <p className="text-gray-500 mt-1">
              Your free trial is still active. Subscribe now to lock in your plan — you won&apos;t be charged until your trial ends.
            </p>
          </>
        ) : (
          <>
