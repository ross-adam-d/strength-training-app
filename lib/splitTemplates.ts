...
const WORKOUT_TYPES: Record<string, WorkoutType> = {
  'Full Body': {
    name: 'Full Body',
    slots: [
      { label: 'Legs (Compound)',  exerciseName: 'Barbell Squat',       equipment: ['barbell', 'rack'],  alternatives: [{ exerciseName: 'Leg Press', equipment: ['machine'] }, { exerciseName: 'Lunges', equipment: ['bodyweight'] }],                                                        buildSets: 4, buildReps: '6-8',   recoverySets: 2, recoveryReps: '8-10',  restPeriod: 180 },
      { label: 'Chest (Compound)', exerciseName: 'Barbell Bench Press', equipment: ['barbell', 'bench'], alternatives: [{ exerciseName: 'Dumbbell Bench Press', equipment: ['bench'] }, { exerciseName: 'Push-ups', equipment: ['bodyweight'] }],                                         buildSets: 4, buildReps: '6-8',   recoverySets: 2, recoveryReps: '8-10',  restPeriod: 150 },
      ...
      { label: 'Shoulders',        exerciseName: 'Overhead Press',      equipment: ['barbell', 'rack'],  alternatives: [{ exerciseName: 'Dumbbell Shoulder Press', equipment: ['dumbbell'] }],                                                                                             buildSets: 3, buildReps: '8-10',  recoverySets: 2, recoveryReps: '10-12', restPeriod: 120 },
  ...
  'Chest': {
    name: 'Chest',
    slots: [
      { label: 'Chest (Flat)',      exerciseName: 'Barbell Bench Press',   equipment: ['barbell', 'bench'], alternatives: [{ exerciseName: 'Dumbbell Bench Press', equipment: ['bench'] }, { exerciseName: 'Push-ups', equipment: ['bodyweight'] }],                                      buildSets: 4, buildReps: '6-8',   recoverySets: 2, recoveryReps: '8-10',  restPeriod: 150 },
      { label: 'Chest (Incline)',   exerciseName: 'Incline Dumbbell Press', equipment: ['dumbbell'],        alternatives: [{ exerciseName: 'Incline Barbell Bench Press', equipment: ['barbell', 'bench'] }, { exerciseName: 'Push-ups', equipment: ['bodyweight'] }],                               buildSets: 3, buildReps: '8-10',  recoverySets: 2, recoveryReps: '10-12', restPeriod: 120 },
      { label: 'Chest (Isolation)', exerciseName: 'Chest Fly (Dumbbell)',  equipment: ['dumbbell'],        alternatives: [{ exerciseName: 'Push-ups', equipment: ['bodyweight'] }],                                                                                                       buildSets: 3, buildReps: '10-12', recoverySets: 2, recoveryReps: '12-15', restPeriod: 90  },
      { label: 'Triceps',           exerciseName: 'Tricep Pushdown',       equipment: ['cable'],           alternatives: [{ exerciseName: 'Overhead Tricep Extension', equipment: ['dumbbell'] }, { exerciseName: 'Tricep Dips', equipment: ['bodyweight'] }],                              buildSets: 3, buildReps: '10-12', recoverySets: 2, recoveryReps: '12-15', restPeriod: 60  },
    ],
  },
  ...
  'Shoulders': {
    name: 'Shoulders',
    slots: [
      { label: 'Shoulders (Press)',  exerciseName: 'Overhead Press',  equipment: ['barbell', 'rack'], alternatives: [{ exerciseName: 'Dumbbell Shoulder Press', equipment: ['dumbbell'] }],          buildSets: 4, buildReps: '6-8',   recoverySets: 2, recoveryReps: '8-10',  restPeriod: 150 },
      { label: 'Side Delts',         exerciseName: 'Lateral Raise',   equipment: ['dumbbell'],        alternatives: [{ exerciseName: 'Front Raise', equipment: ['dumbbell'] }],                     buildSets: 3, buildReps: '12-15', recoverySets: 2, recoveryReps: '15',    restPeriod: 60  },
      { label: 'Rear Delts',         exerciseName: 'Face Pulls',      equipment: ['cable'],           alternatives: [{ exerciseName: 'Lateral Raise', equipment: ['dumbbell'] }],                   buildSets: 3, buildReps: '12-15', recoverySets: 2, recoveryReps: '15',    restPeriod: 60  },
  ...
  'Arms': {
    ...
    slots: [
      ...
      { label: 'Triceps (Compound)',  exerciseName: 'Close Grip Bench', equipment: ['barbell', 'bench'], alternatives: [{ exerciseName: 'Overhead Tricep Extension', equipment: ['dumbbell'] }, { exerciseName: 'Tricep Dips', equipment: ['bodyweight'] }],         buildSets: 3, buildReps: '8-10',  recoverySets: 2, recoveryReps: '10-12', restPeriod: 90  },
