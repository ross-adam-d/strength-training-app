...
const WORKOUT_TYPES: Record<string, WorkoutType> = {
  'Full Body': {
    ...
    slots: [
      ...
      { label: 'Chest (Compound)', exerciseName: 'Barbell Bench Press', equipment: 'bench',     alternatives: [{ exerciseName: 'Dumbbell Bench Press', equipment: 'dumbbell' }, { exerciseName: 'Push-ups', equipment: 'bodyweight' }],                                         buildSets: 4, buildReps: '6-8',   recoverySets: 2, recoveryReps: '8-10',  restPeriod: 150 },
  ...
  'Chest': {
    name: 'Chest',
    slots: [
      { label: 'Chest (Flat)',      exerciseName: 'Barbell Bench Press',   equipment: 'bench',  alternatives: [{ exerciseName: 'Dumbbell Bench Press', equipment: 'dumbbell' }, { exerciseName: 'Push-ups', equipment: 'bodyweight' }],                                      buildSets: 4, buildReps: '6-8',   recoverySets: 2, recoveryReps: '8-10',  restPeriod: 150 },
